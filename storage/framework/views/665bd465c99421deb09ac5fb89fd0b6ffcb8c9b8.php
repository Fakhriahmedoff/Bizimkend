        ...
        <div class="analytics-container">
            ...
            <?php else: ?>
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
                   Burada google analytics olacaq ve order melumatlari
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                ...
                <ul class="FlexGrid saf FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Desktop\bizimkend\vendor\tcg\voyager\src/../resources/views/index.blade.php ENDPATH**/ ?>